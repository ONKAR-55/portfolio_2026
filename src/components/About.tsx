...
export default function About() {
    return (
        <section className="py-16 px-0 w-full max-w-[90%] mx-auto mb-10">
            <h2 className="text-4xl md:text-6xl text-right mt-0 mb-12 dark:text-gray-200">
                About <span className="text-accent">Me</span>
            </h2>
            <AnimatedCard className="h-fit" isStatick={true}>
                <div className="p-5 min-h-75 flex flex-col bg-black/80 rounded-2xl text-left">
                    ...
                    <h2 className="text-sm font-bold text-accent mt-3">Ready to Work With The Industry</h2>
                </div>
            </AnimatedCard>
        </section>
    );
